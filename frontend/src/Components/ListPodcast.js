  ...
  <i class="fas fa-gem"></i>
                        ...
                        <div className="mb-2">
                            <p className="text-muted mb-0">
                                {podcast.description.slice(0, 20)+(podcast.description.length > 20 ? '...':'')}
                            </p>
                            <p className='float-end fw-bold'>{podcast.createdBy}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    return (
        <div>
            ...
            {
                selPodcast ?
                    <PodcastPlayer file={url + '/' + selPodcast.file} />
                    :
                    ""
            }
        </div>
